<template>
    <div class="md:max-w-full max-w-96 bg-gradient-to-  md:px-0 px-5 mx-auto py-12">
        <div class="max-w-7xl mx-auto">
          <span class="text-red-600 py-2 text-xl font-medium">Introduction</span>
          <h1 class="md:text-5xl text-4xl font-extrabold py-4 text-gray-300">Overview</h1>
          <p class="max-w-2xl text-gray-400 font-medium text-lg">
